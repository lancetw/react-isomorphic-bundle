...
TRAVIS_ARGS = cover node_modules/mocha/bin/_mocha --report lcovonly -- --timeout 500000 --harmony --require co-mocha tests/spec.js --compilers js:babel/register -R spec $(TEST_JS) && cat coverage/lcov.info | node_modules/coveralls/bin/coveralls.js && codeclimate < coverage/lcov.info
